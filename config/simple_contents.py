...
ERROR = {
        ...
        'TOTAL_AMOUNT': 'Votre saisie ne correspond pas à un montant valide',
        'REST_AMOUNT': 'Votre saisie ne correspond pas à un montant valide',
        'ATTENDEES': 'Merci d\'entrer un nombre',
        'SELECT_CONTRACT': 'Votre saisie ne correspond pas à un numéro valide',
...
FAILED = {
        ...
        'PHONE': 'Le numéro de téléphone ne peut être vide',
        'EMAIL': 'l\'adresse mail ne peut être vide',
        'CLIENT_EMAIL': 'l\'adresse mail ne peut être vide',
        'PASSWORD': 'Votre mot de passe ne peut pas être vide',
        ...
        'DEPARTMENT': 'Le département ne peut pas être vide',
        'EMPLOYEE_NUMBER': 'Le numéro d\'employé ne peut être vide',
}
